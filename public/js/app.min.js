...
;jQuery(document).ready(function(t){var e={url:"/search",getValue:function(t){return t.first_name+" "+t.last_name},list:{maxNumberOfElements:10,match:{enabled:!0},showAnimation:{type:"fade",time:400,callback:function(){}},hideAnimation:{type:"slide",time:400,callback:function(){}},onSelectItemEvent:function(){var e=t("#user").getSelectedItemData();t("#user_id").val(e.id)},onClickEvent:function(){var e=t("#user").getSelectedItemData();window.location.href="/desaparecidos/"+e.id+"/edit"}},template:{type:"iconLeft",fields:{iconSrc:"photo"}},ajaxSettings:{dataType:"json",method:"GET",data:{}},preparePostData:function(e){return e.term=t("#user").val(),e},theme:"bootstrap",requestDelay:500};t("#user").easyAutocomplete(e)});
